...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateCalculations() {
        ...
        document.querySelector('[data-internal-value="attackpower"]').textContent = attackPower;
        document.querySelector('[data-internal-value="defensepower"]').textContent = defensePower;
        document.querySelector('[data-internal-value="TTK"]').textContent = ttk;
    }
