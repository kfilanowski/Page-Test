(function(){
  /* Obsidian-Publish shim so Meta-Bind can run in a static site */
  ...
  DummyPlugin.Plugin = DummyPlugin;

  var module  = { exports: {} };
  var exports = module.exports;

  function require(name){
    if (name && name.startsWith("obsidian")) return shim;
    return {};
  }

  /* === Meta-Bind Publish build === */
