...
function initializeHoverPreview() {
  ...
  function getBasePath() {
    ...
    // If we have no base, try to determine from current path
    if (!basePath) {
      // Get the current pathname and calculate the path to the root
  ...
  function resolveUrl(href) {
    ...
    if (href.startsWith('/')) {
      // Join with origin to get the full URL
    ...
    console.log('Resolved URL:', { original: href, base: basePath, resolved: url });
