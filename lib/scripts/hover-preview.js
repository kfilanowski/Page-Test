  ...
  function setupLinkHover(link) {
      ...
      if (isNested) {
        ...
        if (!nestedPreviewEl) {
          ...
          nestedPreviewEl.addEventListener('mouseleave', function(e) {
            // Check if we moved directly to another preview
            const relatedTarget = e.relatedTarget;
            if (!isElementOrChildOf(relatedTarget, nestedPreviewEl)) {
    ...
    link.addEventListener('mouseover', function() {
      ...
      if (activeLinks.has(link)) {
        ...
        // Also cancel for any nested preview associated with this link
